...
#   --user U           guest account for --sysprep (default fxdev)
#   --pass P           guest password for --sysprep (or FXWD_PASSWORD; prompted if unset)
#
...
name=firefox-win-dev hv="" out="" sysprep=0 guser=fxdev gpass="${FXWD_PASSWORD:-}"
while [[ $# -gt 0 ]]; do
  case "$1" in
    --name) name=$2; shift 2;;
